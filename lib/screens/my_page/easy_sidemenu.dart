...
class EasySideMunu extends StatefulWidget {
  const EasySideMunu({Key? key}) : super(key: key);

  @override
  _EasySideMunuState createState() => _EasySideMunuState();
}

class _EasySideMunuState extends State<EasySideMunu> {
          ...
          SideMenu(
            ...
            style: SideMenuStyle(
                ...
                unselectedTitleTextStyleExpandable:
                    TextStyle(color: AppColors.witchColor)
